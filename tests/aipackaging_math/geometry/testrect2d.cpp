...
TEST(rect2D, ContainsBase)
{
  ...
  // Прямоугольник, находящийся в rect полностью
...
// Тест метода intersects при полном вхождении объекта
...
// Тестирование результаты метода contains при пересечении с прямоугольником
TEST(rect2D, containsNotEqualIntersects)
{
  Rect2D rect{{0, 0}, {10, -10}};

  // Прямоугольник, находящийся в rect частично
