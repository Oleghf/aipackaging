"""Тесты строгих ML-контрактов, не требующие нативного binding."""
...
def test_canonical_training_config_is_strict() -> None:
    """Канонический config принимается, а неизвестное поле отклоняется."""
...
def test_training_config_rejects_invalid_ranges_and_hash() -> None:
    """Неверный бюджет и checksum не проходят ручную schema-проверку."""
