...
Документ фиксирует проект архитектуры на момент аудита A0. Фактическое состояние
после A8 описано в [архитектуре проекта](architecture.md): унаследованный
клеточный настольный контур уже удалён.
