...
Desktop-интеграция M5 дополнительно проверяет отсутствие мутаций QWidget из
worker-потока, cooperative cancellation, игнорирование запоздалого progress,
повторную валидацию перед публикацией и сохранение прежней сцены при ошибке
загрузки или backend-а.
