...
В правой панели рабочего места пользователь выбирает каталог командой
...
доступны режимы «Быстрый» и «Качественный», а все пять базовых алгоритмов можно
выбрать в расширенных настройках. Нейросетевой и рекомендуемый гибридный режимы
до успешной проверки модели заблокированы.
...
Хеши канонического комплекта и результаты оценки приведены в
